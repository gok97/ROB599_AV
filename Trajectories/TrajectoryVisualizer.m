...
%% Visualize
plot_data = {xDesired(1, :), xDesired(2, :), xDesired(3, :), xDesired(4, :), xDesired(5, :), xDesired(6, :), wind_random(:, 1), wind_random(:, 2), mass_step(:, 1), wind_ramp(:, 1), wind_ramp(:, 2), mass_ramp(:, 1)};
tot_inc = 0.05;
